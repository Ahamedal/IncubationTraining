	...
	public static void main(String[] args) {
		...
		while(condition) {
			...
			case 3:
				...
				System.out.println("1.Show to display items 2.Show to display less than or equal to(10) 3.reOrder 4.Update discount of item 5.exit");
				int see=sc.nextInt();
				sc.nextLine();
				switch(see) {
				case 1:
				...
				case 2:
				   ...
				   if(!temp.startsWith("No")) {
					   System.out.println("ProductId\t\tCategory\t\tBrand\t\t\tModel\t\t\tPrice\t\t\tStock\t\t\tDiscount\n");
				   }
